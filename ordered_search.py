...
def ordered_search(index, ranks, keyword):
    def quicksort(list):
        if list == []: 
            ...
            pivot = list[0]
            lesser = quicksort([x for x in list[1:] if x[0] < pivot[0]])
            greater = quicksort([x for x in list[1:] if x[0] >= pivot[0]])
...
#print ordered_search.ordered_search(index, ranks, 'Hummus')
...
#print ordered_search.ordered_search(index, ranks, 'the')
#>>> ['http://udacity.com/cs101x/urank/nickel.html', 
#    'http://udacity.com/cs101x/urank/arsenic.html', 
#    'http://udacity.com/cs101x/urank/hummus.html', 
#    'http://udacity.com/cs101x/urank/index.html']
