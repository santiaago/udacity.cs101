...
#index, graph = lucky_search.crawl_web('http://udacity.com/cs101x/urank/index.html')
#ranks = lucky_search.compute_ranks(graph)

#print lucky_search.lucky_search(index, ranks, 'Hummus')
#>>> http://udacity.com/cs101x/urank/kathleen.html

#print lucky_search.lucky_search(index, ranks, 'the')
#>>> http://udacity.com/cs101x/urank/nickel.html

#print lucky_search.lucky_search(index, ranks, 'babaganoush')
#>>> None
